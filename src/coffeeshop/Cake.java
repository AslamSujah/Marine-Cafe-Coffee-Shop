...
public class Cake extends javax.swing.JFrame {
    ...
    public Cake() {
        ...
        items=new ArrayList<CakeItem>();
        items.add(new CakeItem(1,"Butter Cake-500g", 25, 255.00f, 2));
        items.add(new CakeItem(2,"Butter Cake-1kg", 15, 400.00f, 5));
        items.add(new CakeItem(3,"Orange Cake-500g",10, 450.00f, 3));
        items.add(new CakeItem(4,"Orange Cake-1kg",8,750.00f, 1));
        items.add(new CakeItem(5,"Lemon Cake-400g", 12, 350.00f, 4));
        items.add(new CakeItem(6,"Lemon Cake-900g", 14, 650.00f, 7));
        items.add(new CakeItem(7,"Carrot Cake-1kg", 12, 550.00f, 2));
        items.add(new CakeItem(8,"Chocolate Cake-500g", 25, 950.00f, 9));
        items.add(new CakeItem(9,"Caramel Cake-1kg", 10, 650.00f, 5));
        items.add(new CakeItem(10,"Banana Cake-700g", 5, 250.00f, 9));
        items.add(new CakeItem(11,"Strawberry Cake-1kg", 8, 1250.00f, 9));
        items.add(new CakeItem(12,"Coconut Cake-1kg", 12, 350.00f, 4));
        items.add(new CakeItem(13,"Apple Cake-400g", 12, 350.00f, 1));
        items.add(new CakeItem(14,"Peach Cake-700g", 12, 600.00f, 7));
        items.add(new CakeItem(15,"Fruit Cake-1kg", 30, 400.00f, 6));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        else if(state ==8)
        {
            ...
            Collections.sort(items,new CakeSortByQuantity());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        else if(state ==8)
        {
            ...
            Collections.sort(items,new CakeSortByPrefernce());
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        else if(state==7)
        {
            ...
            CakeItem itm=(CakeItem)jComboBox2.getSelectedItem();
            itm.setQUANTITY(i);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        else if(state==4)
        {
            ...
            CakeItem itm=(CakeItem)jComboBox1.getSelectedItem();
