...
enum Status2{SUCCESS,FAIL};

public class IceCream extends javax.swing.JFrame {
    
    private String nextCard;
    private List<IceCreamItem>items;
    private int state=0;
    private Status2 flag;
    ...
    public IceCream() {
        ...
        items=new ArrayList<IceCreamItem>();
        items.add(new IceCreamItem(31,"Vanilla", 40, 55.00f, 2));
        items.add(new IceCreamItem(32,"Mango", 25, 65.00f, 5));
        items.add(new IceCreamItem(33,"Strawberry",37, 45.00f, 3));
        items.add(new IceCreamItem(34,"Chocolate",50,70.00f, 1));
        items.add(new IceCreamItem(35,"Orange Xpress", 20, 150.00f, 4));
        items.add(new IceCreamItem(36,"Pineapple Supreme", 40, 160.00f, 7));
        items.add(new IceCreamItem(37,"Black Currant", 30, 175.00f, 2));
        items.add(new IceCreamItem(38,"Kaju Kismis", 25, 200.00f, 9));
        items.add(new IceCreamItem(39,"Belgium Chocolate", 75, 150.00f, 5));
        items.add(new IceCreamItem(40,"Chocolate Brownie", 45, 110.00f, 9));
        items.add(new IceCreamItem(41,"Fruit Overload", 18, 100.00f, 9));
        items.add(new IceCreamItem(42,"Butterscotch", 28, 130.00f, 4));
        items.add(new IceCreamItem(43,"Vanilla & Chocolate", 17, 255.00f, 1));
        items.add(new IceCreamItem(44,"Caramel", 15, 35.00f, 7));
        items.add(new IceCreamItem(45,"Mello Jello", 30, 50.00f, 6));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        else if(state ==8)
        {
            ...
            Collections.sort(items,new IceCreamSortByQuantity());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        else if(state ==8)
        {
            ...
            Collections.sort(items,new IceCreamSortByPrefernce());
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        else if(state==7)
        {
            ...
            IceCreamItem itm=(IceCreamItem)jComboBox2.getSelectedItem();
            itm.setQUANTITY(i);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        else if(state==4)
        {
            ...
            IceCreamItem itm=(IceCreamItem)jComboBox1.getSelectedItem();
