...
enum Status7{SUCCESS,FAIL};

public class ShortSnack extends javax.swing.JFrame {
    
    private String nextCard;
    private List<ShortSnackItem>items;
    private int state=0;
    private Status7 flag;
    ...
    public ShortSnack() {
        ...
        items=new ArrayList<ShortSnackItem>();
        items.add(new ShortSnackItem(76,"Green Salad", 15, 95.00f, 2));
        items.add(new ShortSnackItem(77,"Cherry Tomatoes", 25, 65.00f, 5));
        items.add(new ShortSnackItem(78,"Frozen Mangos",30, 105.00f, 3));
        items.add(new ShortSnackItem(79,"Soy Chips",50,90.00f, 1));
        items.add(new ShortSnackItem(80,"Bean Salad", 20, 50.00f, 4));
        items.add(new ShortSnackItem(81,"Tuna", 40, 60.00f, 7));
        items.add(new ShortSnackItem(82,"Olives", 30, 305.00f, 2));
        items.add(new ShortSnackItem(83,"Protein Bars", 25, 150.00f, 9));
        items.add(new ShortSnackItem(84,"Hummus", 75, 160.00f, 5));
        items.add(new ShortSnackItem(85,"Almonds", 45, 245.00f, 9));
        items.add(new ShortSnackItem(86,"Frozen Grapes", 18, 105.00f, 9));
        items.add(new ShortSnackItem(87,"Orange Slices", 28, 40.00f, 4));
        items.add(new ShortSnackItem(88,"Hard Boiled Eggs", 17, 115.00f, 1));
        items.add(new ShortSnackItem(89,"Sliced Apples", 15, 35.00f, 7));
        items.add(new ShortSnackItem(90,"Peanut Butter", 30, 350.00f, 6));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        else if(state ==8)
        {
            ...
            Collections.sort(items,new ShortSnackSortByQuantity());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        else if(state ==8)
        {
            ...
            Collections.sort(items,new ShortSnackSortByPrefernce());
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        else if(state==7)
        {
            ...
            ShortSnackItem itm=(ShortSnackItem)jComboBox2.getSelectedItem();
            itm.setQUANTITY(i);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        else if(state==4)
        {
            ...
            ShortSnackItem itm=(ShortSnackItem)jComboBox1.getSelectedItem();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ShortSnack().setVisible(true);
            }
        });
    }
