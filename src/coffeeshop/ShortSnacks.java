...
public class ShortSnacks extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(450, 100, 150, 60);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Theme7.jpg"))); // NOI18N
        jPanel1.add(jLabel1);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ShortSnack s = new ShortSnack();
        s.setVisible(true);
        ShortSnacks.this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ShortSnacks().setVisible(true);
            }
        });
    }
