...
enum Status5{SUCCESS,FAIL};

public class Juice extends javax.swing.JFrame {
    
    private String nextCard;
    private List<SandwicheItem>items;
    private int state=0;
    private Status5 flag;
    ...
    public Juice() {
        ...
        items=new ArrayList<SandwicheItem>();
        items.add(new SandwicheItem(46,"Orange Juice", 15, 55.00f, 2));
        items.add(new SandwicheItem(47,"Mango Juice", 25, 65.00f, 5));
        items.add(new SandwicheItem(48,"Strawberry Juice",30, 145.00f, 3));
        items.add(new SandwicheItem(49,"Grape Juice",50,100.00f, 1));
        items.add(new SandwicheItem(50,"Black-Berry", 20, 150.00f, 4));
        items.add(new SandwicheItem(51,"Pineapple Juice", 40, 60.00f, 7));
        items.add(new SandwicheItem(52,"Apple Juice", 30, 45.00f, 2));
        items.add(new SandwicheItem(53,"Lemon Juice", 25, 50.00f, 9));
        items.add(new SandwicheItem(54,"Mix Fruit", 75, 60.00f, 5));
        items.add(new SandwicheItem(55,"Papaya", 45, 35.00f, 9));
        items.add(new SandwicheItem(56,"Peach Juice", 18, 250.00f, 9));
        items.add(new SandwicheItem(57,"Ali pera Juice", 28, 40.00f, 4));
        items.add(new SandwicheItem(58,"Chocolate Mixed Mango", 17, 115.00f, 1));
        items.add(new SandwicheItem(59,"Carrot Juice", 15, 35.00f, 7));
        items.add(new SandwicheItem(60,"Olive Juice", 30, 350.00f, 6));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        else if(state ==8)
        {
            ...
            Collections.sort(items,new SandwicheSortByQuantity());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        else if(state ==8)
        {
            ...
            Collections.sort(items,new SandwicheSortByPrefernce());
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        else if(state==7)
        {
            ...
            SandwicheItem itm=(SandwicheItem)jComboBox2.getSelectedItem();
            itm.setQUANTITY(i);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        else if(state==4)
        {
            ...
            SandwicheItem itm=(SandwicheItem)jComboBox1.getSelectedItem();
