...
public class Coffee extends javax.swing.JFrame {
    ...
    public Coffee() {
        ...
        items=new ArrayList<CoffeeItem>();
        items.add(new CoffeeItem(16,"Cappuccino-250ml", 100, 55.00f, 2));
        items.add(new CoffeeItem(17,"Mocha Coffee-Single", 125, 150.00f, 5));
        items.add(new CoffeeItem(18,"Mocha Coffee-Couple",100, 200.00f, 3));
        items.add(new CoffeeItem(19,"Doppio Coffee-Single",25,150.00f, 1));
        items.add(new CoffeeItem(20,"Doppio Coffee-Couple", 20, 250.00f, 4));
        items.add(new CoffeeItem(21,"Long Black-Couple", 40, 250.00f, 7));
        items.add(new CoffeeItem(22,"Long Black-promoPack", 30, 400.00f, 2));
        items.add(new CoffeeItem(23,"Chocolate Coffee-Couple", 25, 450.00f, 9));
        items.add(new CoffeeItem(24,"Espresso Coffee", 25, 150.00f, 5));
        items.add(new CoffeeItem(25,"Latte Coffee-Single", 45, 110.00f, 9));
        items.add(new CoffeeItem(26,"Latte Coffee-Couple", 18, 200.00f, 9));
        items.add(new CoffeeItem(27,"Flat White Coffee-Hot", 28, 130.00f, 4));
        items.add(new CoffeeItem(28,"Flat White Coffee-Cool", 17, 115.00f, 1));
        items.add(new CoffeeItem(29,"White Chocolate-Hot", 15, 300.00f, 7));
        items.add(new CoffeeItem(30,"White Chocolate-Cool", 30, 250.00f, 6));
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel8Layout.createSequentialGroup()
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel8Layout.createSequentialGroup()
                        ...
                        .addGap(43, 43, 43)
                        .addComponent(jLabel41, javax.swing.GroupLayout.DEFAULT_SIZE, 126, Short.MAX_VALUE))
                    .addGroup(jPanel8Layout.createSequentialGroup()
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        else if(state ==8)
        {
            ...
            Collections.sort(items,new CoffeeSortByQuantity());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        else if(state ==8)
        {
            ...
            Collections.sort(items,new CoffeeSortByPrefernce());
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        else if(state==7)
        {
            ...
            CoffeeItem itm=(CoffeeItem)jComboBox2.getSelectedItem();
            itm.setQUANTITY(i);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        else if(state==4)
        {
            ...
            CoffeeItem itm=(CoffeeItem)jComboBox1.getSelectedItem();
